...
export default function Categories() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        // First try to fetch from the new categories API
        ...
        if (res.ok) {
          ...
          if (data.success && data.flatCategories) {
          ...
          console.log("Categories API not available, falling back to products");
          await fetchCategoriesFromProducts();
        }
      } catch (error) {
        console.warn("Failed to fetch from categories API, falling back to products:", error);
        await fetchCategoriesFromProducts();
      } finally {
        setLoading(false);
      }
