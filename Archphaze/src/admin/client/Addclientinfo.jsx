...
export default function Addclientinfo() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.client_image) return setError("Client image is required.");
    ...
    try {
      ...
      body.append("client_image", formData.client_image);
      ...
      const res = await fetch("/backend/client/create", {
        method: "POST",
        body,
      });
      ...
      if (!res.ok) {
        return setError(data.error || "Failed to create client.");
      }
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="e.g. Leading IT services and consulting company."
